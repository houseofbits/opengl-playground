...
void LightsUniformBuffer::create(unsigned int maxLights, unsigned int uniformBindingIndex) {
    maxActiveLights = maxLights;
    uniformBuffer.create(maxActiveLights, LightUniformBuffer::DYNAMIC, uniformBindingIndex);
