...
void TextureAtlasManager::init(unsigned int uniformBindingIndex) {
    ...
    initAtlasRegionsMapping(uniformBindingIndex);
}
...
void TextureAtlasManager::initAtlasRegionsMapping(unsigned int uniformBindingIndex) {
    ...
    atlasRegionsMapping.create(quadTree.getNumNodes(), UniformBuffer<glm::vec4>::STATIC, uniformBindingIndex);
