#include "PhysicsDistanceJointComponentTransformEdit.h"
...
PhysicsDistanceJointComponentTransformEdit::TransformOption PhysicsDistanceJointComponentTransformEdit::getTransformTargetOptions(int index) {
    switch (index) {
        case 1:
            return {
                "Attachment point A",
...
glm::mat4 PhysicsDistanceJointComponentTransformEdit::getWorldSpaceTransform(int index) {
...
void PhysicsDistanceJointComponentTransformEdit::setWorldSpaceTransform(glm::mat4 m, int index) const {
    if (m_linkedTransformA == nullptr || m_linkedTransformB == nullptr) {
        return;
    }
...
void PhysicsDistanceJointComponentTransformEdit::handleEntitySelection(Entity &e, Component *c) {
...
TransformComponent *PhysicsDistanceJointComponentTransformEdit::getTransformComponentByName(const std::string &name) const {
    if (name.empty()) {
