...
class CameraComponentTransformEdit final : public ComponentEdit<CameraComponent> {
public:
    explicit CameraComponentTransformEdit(EditorUISystem &editorSystem) : ComponentEdit(editorSystem) {
    }
